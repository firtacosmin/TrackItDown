...
public class GameLvlMng_lvl3 extends GameLvlMng_lvl{
	...
	public GameLvlMng_lvl3(Context c){
		super(true);
		_speed = _lvl3_speed;
...
//		_circleRadius = _lvl3_circleRadius
		...
		setWinningCircleImg(c.getResources().getDrawable(R.drawable.ball_3));
		setCircleImg(c.getResources().getDrawable(R.drawable.ball_1));
