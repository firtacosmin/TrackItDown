...
public class ProgressDbHelper extends SQLiteOpenHelper{
    ...
    public static final String DATABASE_NAME = "trackitdown.db";
    
    private static final String COMMA_SEP = ",";
    private static final String SQL_CREATE_ENTRIES =
        "CREATE TABLE " + Progress.TABLE_NAME + " (" +
        		Progress._ID + " INTEGER PRIMARY KEY" + COMMA_SEP +
        		Progress.COLUMN_CURRENT_LEVEL + " INTEGER" + 
        " )";

    private static final String SQL_DELETE_ENTRIES =
        "DROP TABLE IF EXISTS " + Progress.TABLE_NAME;
