...
public class GameLvlMngGenerator {
	...
	public static GameLvlMng getLvl(LEVELS lvl, Context c){
		...
		case LEVEL_2:
			...
			break;
		case LEVEL_3:
			 circle_no = R.integer.circle_no_3;
			 winning_circle_no = R.integer.winning_circle_no_3;
			 circle_speed = R.integer.circle_speed_3;
			 observe_time = R.integer.observe_time_3;
			 seek_time = R.integer.seek_time_3;
			 circle_radius = R.integer.circle_radius_3;
			...
			break;
		case LEVEL_4:
			 circle_no = R.integer.circle_no_4;
			 winning_circle_no = R.integer.winning_circle_no_4;
			 circle_speed = R.integer.circle_speed_4;
			 observe_time = R.integer.observe_time_4;
			 seek_time = R.integer.seek_time_4;
			 circle_radius = R.integer.circle_radius_4;
			...
			break;
		case LEVEL_5:
			 circle_no = R.integer.circle_no_5;
			 winning_circle_no = R.integer.winning_circle_no_5;
			 circle_speed = R.integer.circle_speed_5;
			 observe_time = R.integer.observe_time_5;
			 seek_time = R.integer.seek_time_5;
			 circle_radius = R.integer.circle_radius_5;
			...
			break;
		case LEVEL_6:
			 circle_no = R.integer.circle_no_6;
			 winning_circle_no = R.integer.winning_circle_no_6;
			 circle_speed = R.integer.circle_speed_6;
			 observe_time = R.integer.observe_time_6;
			 seek_time = R.integer.seek_time_6;
			 circle_radius = R.integer.circle_radius_6;
			...
			break;
		case LEVEL_7:
			 circle_no = R.integer.circle_no_7;
			 winning_circle_no = R.integer.winning_circle_no_7;
			 circle_speed = R.integer.circle_speed_7;
			 observe_time = R.integer.observe_time_7;
			 seek_time = R.integer.seek_time_7;
			 circle_radius = R.integer.circle_radius_7;
			...
			break;
		case LEVEL_8:
			 circle_no = R.integer.circle_no_8;
			 winning_circle_no = R.integer.winning_circle_no_8;
			 circle_speed = R.integer.circle_speed_8;
			 observe_time = R.integer.observe_time_8;
			 seek_time = R.integer.seek_time_8;
			 circle_radius = R.integer.circle_radius_8;
			...
			break;
		case LEVEL_9:
			 circle_no = R.integer.circle_no_9;
			 winning_circle_no = R.integer.winning_circle_no_9;
			 circle_speed = R.integer.circle_speed_9;
			 observe_time = R.integer.observe_time_9;
			 seek_time = R.integer.seek_time_9;
			 circle_radius = R.integer.circle_radius_9;
